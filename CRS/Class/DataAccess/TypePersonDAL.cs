...
{
    public class TypePersonDAL
    {
        public static DataSet SelectTypePersonByID(int? typeID)
        {
            string sql = null;
            if (typeID == null)
            ...
            {
                return null;
                GlobalProcedures.LogWrite("Əyyarlar açılmadı.", sql, GlobalVariables.V_UserName, "TypePersonDAL", "SelectTypePersonByID", exx);
            }
        }
    }
}
