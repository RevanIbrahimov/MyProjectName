...
namespace   CRS.Class.DataAccess
{
    ...
    {
        public static DataSet SelectGoldTypeByID(int? typeID)
        {
            string sql = null;
            if (typeID == null)
            ...
            {
                return null;
                GlobalProcedures.LogWrite("Əyyarlar açılmadı.", sql, GlobalVariables.V_UserName, "GoldTypeDAL", "SelectGoldTypeByID", exx);
            }
        }
    }
}
